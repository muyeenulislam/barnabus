...
const HomeHeroFive = memo(function HomeHeroFive({
  headlineClass,
  subtitleClass,
  actionButtons,
}) {
  return (
    ...
    >
      <video
        className="lg:hidden absolute top-0 left-0 w-full h-[20rem] lg:h-full object-cover fade-bottom-teal-25"
        autoPlay
        muted
        loop
      >
        <source src="/videos/hero-five.webm" type="video/mp4" />
      </video>
      <video
        className="hidden lg:block absolute top-0 left-0 w-full h-[20rem] lg:h-full object-cover"
        autoPlay
        muted
        loop
      >
      ...
      <div className="lg:hidden absolute top-0 left-0 w-full h-full hero-four-gradient z-10" />
      <div className="hidden lg:block absolute top-0 left-0 w-full h-full hero-five-gradient z-10" />
